...
document.addEventListener("DOMContentLoaded",()=>{
    const createUser:HTMLFormElement=document.getElementById("create-user") as  HTMLFormElement;
    const getButton:HTMLFormElement=document.getElementById("get-button") as HTMLFormElement;
...
//READ
    getButton.addEventListener("click",function (){
        ...
        axios.get("/users",{
            ...
            const data:FormData=new FormData(createUser);
            let a=value.data;
...
//CREATE
    createUser.addEventListener("submit",(event:Event)=>{
...
//UPDATE
    function myFunction1(vorname,nachname,email){
        ...
        let n1input=document.createElement("input");
        n1input.value=nachname;
        let n2input=document.createElement("input");
        n2input.value=email;
        let n3input=document.createElement("input");//alte password
        n3input.type="password";
        n3input.placeholder="Alte password";
        let n4input=document.createElement("input");//neu password
        n4input.type="password";
        n4input.placeholder="Neue password";
        let n5input=document.createElement("input");//neue password
        ...
        let x=document.getElementById("newform");
